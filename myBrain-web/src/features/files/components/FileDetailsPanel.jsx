...
export default function FileDetailsPanel({ file: initialFile, onClose, onUpdated, onDeleted }) {
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div className="fixed top-0 right-0 h-full w-full max-w-lg bg-panel glass-heavy border-l border-border shadow-theme-2xl z-50 flex flex-col transition-transform duration-300 ease-out translate-x-0">
        {/* Header */}
